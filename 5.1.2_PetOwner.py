...
def get_owner_string(the_pet):
    first = the_pet.name.first
    last = the_pet.name.last
    
    owner_first = the_pet.owner.name.first
    owner_last = the_pet.owner.name.last
    return first+" "+last+"'s owner is "+owner_first+" "+owner_last+"."
